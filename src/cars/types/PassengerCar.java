...
public abstract class PassengerCar extends Car {
    ...
    public PassengerCar(String model, String color, MaxSpeed maxSpeed, boolean isMotionNow,
                        Transmission transmission, CarModel carModel, Electrician electrician, Engine engine,
        ...
        super(model, color, maxSpeed, isMotionNow, transmission, carModel, electrician,
